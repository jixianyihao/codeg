...
principals = Table(
    ...
    Column("display_name", String(200, collation="utf8mb4_unicode_ci"), nullable=False),
...
dashboards = Table(
    ...
    Column("owner_principal_id", ID, ForeignKey("principals.id", name="fk_dashboards_owner"),
           nullable=False),
    Column("title", String(200, collation="utf8mb4_unicode_ci"), nullable=False),
    Column("description", String(2000, collation="utf8mb4_unicode_ci"), nullable=False, default=""),
...
audit_events = Table(
    ...
    Column("reason", String(500, collation="utf8mb4_unicode_ci"), nullable=True),
