...
dashboards = Table(
    ...
    Column("revision", Integer, nullable=False, default=1),
    Column("status", String(16, collation="ascii_bin"), nullable=False, default="published"),
    Column("created_at", DT, nullable=False),
    Column("updated_at", DT, nullable=False),
    Column("published_at", DT, nullable=False),
    CheckConstraint("status IN ('published','archived')", name="ck_dashboards_status"),
